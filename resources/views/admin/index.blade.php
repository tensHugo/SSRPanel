          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2 bordered">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-green-sharp">
                                <span data-counter="counterup" data-value="{{$todayUser}}"></span>
                            </h3>
                            <small>今日注册人数</small>
                        </div>
                        <div class="icon">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2 bordered">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-green">
                                $<span data-counter="counterup" data-value="{{$todayCz}}"></span>
                            </h3>
                            <small>今日充值金额</small>
                        </div>
                        <div class="icon">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat2 bordered">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-green">
                                $<span data-counter="counterup" data-value="{{$mCz}}"></span>
                            </h3>
                            <small>本月充值金额</small>
                        </div>
                        <div class="icon">
