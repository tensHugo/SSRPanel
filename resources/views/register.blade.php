...
<div class="content">
    ...
    <form class="register-form" action="{{url('register')}}" method="post" style="display: block;">
        @if($is_register)
           ...
           <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">用途</label>
                <select name="usage" class="form-control placeholder-no-fix">
                   <option selected="selected" value="0">请选择用途</option>
            ...
            @if($is_invite_register)
              ...
              <!--  <p class="hint"> <a href="//shang.qq.com/wpa/qunwpa?idkey=fb7e361fcd4a69934287c03e6faf33870291fef427e2e3c66e4dbfa9be787647" target="_blank">获取免费邀请码</a> </p> -->
            @endif
            @if($is_captcha)
