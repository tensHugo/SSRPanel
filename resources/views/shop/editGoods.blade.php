                    ...
                    <div class="portlet-body form">
                        ...
                        <form action="{{url('shop/editGoods')}}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                            <div class="form-body">
                              ...
                              <div class="form-group">
                                    <label class="control-label col-md-2">用户等级</label>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" name="level" value="{{$goods->level}}" id="level" placeholder="" required>
                                        <span class="help-block">对应用户的等级，流量套餐请填0</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <span class="help-block">到期后会自动扣除流量（流量套餐此参数无效）</span>
                                    </div>
                                </div>
