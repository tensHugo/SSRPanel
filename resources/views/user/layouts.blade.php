    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
               ...
               <li class="nav-item {{in_array(Request::path(), ['user/qyorderList']) ? 'active open' : ''}}">
                    <a href="{{url('user/qyorderList')}}" class="nav-link nav-toggle">
               ...
               <li class="nav-item">
                    <a href="https://www.fiypig.org" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                        <span class="title">{{trans('home.whome')}}</span>
                        <span class="selected"></span>
                    </a>
                </li>
                @endif
